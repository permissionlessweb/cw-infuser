...
export type ExecuteMsg =
  ...
  | { update_infusions_eligible_collections: { id: number; to_add: EligibleNFTCollection[]; to_remove: EligibleNFTCollection[] } } |
  | { update_infusion_mint_fee: { id: number; mint_fee: Coin | null } } |
  | { update_infusion_bundle_type: { bundle_type: BundleType; id: number } } |
  | { shuffle: { id: number } };
...
export type QueryMsg =
  ...
  | { is_in_bundle: { collection_addr: Addr; infusion_id: number } } |
