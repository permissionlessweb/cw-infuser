...
//! # Run
//!
//! `RUST_LOG=info cargo run --bin --features="daemon-bin" local_daemon --package cw-infuser`
use cw_infuser::MY_APP_ID;
...
fn main() -> anyhow::Result<()> {
    ...
    use cw_infuser::msg::{CwInfuserExecuteMsgFns, CwInfuserQueryMsgFns};
